...
export const en: I18n = {
  ...
  pd: {
    ...
    fanctal: {
      ...
      introEyebrow: 'Interactive companion to a research paper',
      introLead: 'The fanctal is a self-similar circular fractal: divide a disk into six sectors, inscribe a tangent child disk in three alternating sectors, and repeat the construction indefinitely inside each child. Explore the family behind it below, or read the summary and download a Python implementation further down the page.',
      ...
      paperStatus: 'Manuscript in preparation, currently in the review and submission process to Eco Matemático (UFPS). The link to the full article will be added here once it is published.',
      citationLabel: 'Suggested citation (APA, manuscript in preparation)',
      citationText: 'Díaz Arcila, Y., Díaz Gómez, J. M., & Solórzano Tovar, E. (in preparation). <em>The Fanctal: Area, Perimeter, and a Generalized Family of Self-Similar Circular Fractals</em>. Manuscript in preparation for submission to Eco Matemático.',
      licenseNote: 'It will be published under a CC BY 4.0 license.',
      codeTitle: 'Reproduce it in Python',
      codeIntro: 'This script implements the same recursive construction described above — sector selection, scale ratio, and termination criteria — so you can regenerate every figure independently, in your own language if you prefer.',
      codeShow: 'Show code',
      codeHide: 'Hide code',
      codeCopy: 'Copy',
      codeCopied: 'Copied!',
